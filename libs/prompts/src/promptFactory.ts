...
export class PromptFactory {
  private readonly builders: Map<string, AbstractPromptBuilder<Record<string, any>>>;
  ...
  constructor(
    ...
    this.builders = new Map<string, AbstractPromptBuilder<Record<string, any>>>([
  ...
  getBuilder(promptKey: PromptKeys): AbstractPromptBuilder<Record<string, any>> {
